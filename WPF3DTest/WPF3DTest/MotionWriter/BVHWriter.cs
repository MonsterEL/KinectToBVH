...
namespace WPF3DTest
{
    public class BVHWriter
    {
        ...
        public BVHWriter(StructuredSkeleton structuredSkeleton)
        {
        ...
        public void OutputBVHToFile(string path = "d:/Kinect.bvh")
        {
            ...
            // all the joints
            buildBVHOutputSkeleton(_structuredSkeleton.hipRoot);
            ...
            // write out
            using (StreamWriter bvhStreamWriter = new StreamWriter(path))
            {
        ...
        public void AppendOneMotionFrame()
        {
            ...
            {
                if (JointType.HipCenter == node.JointIndex)
                    appendOffsetToBVHBuffer(_structuredSkeleton.hipRoot.Offset);
